...
def compute_normal_histograms(normal_cloud):
    ...
    x_hist = np.histogram(norm_x_vals, bins=100, range=(-1.0, 1.0))
    y_hist = np.histogram(norm_y_vals, bins=100, range=(-1.0, 1.0))
    z_hist = np.histogram(norm_z_vals, bins=100, range=(-1.0, 1.0))    
